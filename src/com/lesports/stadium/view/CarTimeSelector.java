...
public class CarTimeSelector {
     ...
     * @param endDate
     */
    public CarTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate) {
     ...
     */
    public CarTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            ...
            seletorDialog.setContentView(R.layout.dialog_cartimeselector);
    ...
    private void initTimer() throws Exception {
        ...
        if (spanYear) {
            ...
            for (int i = startDay; i <= startCalendar.getActualMaximum(Calendar.DAY_OF_MONTH); i++) {
            	String weekStr=String.valueOf(startYear)+"-"+month.get(0)+"-"+fomatTimeUnit(i);
            	day.add(month.get(0)+"月"+fomatTimeUnit(i)+"日"+" "+dayForWeek(weekStr));
            }
  ...
  /*      year_pv.setOnSelectListener(new PickerView.onSelectListener() {
        ...
        day_pv.setOnSelectListener(new PickerView.onSelectListener() {
            @Override
            public void onSelect(String text) {
            	String[] splitText=text.split("月");
            	String[] splitDay=splitText[1].split("日");
                selectedCalender.set(Calendar.DAY_OF_MONTH, Integer.parseInt(splitDay[0]));
                hourChange();
