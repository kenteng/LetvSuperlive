 ...
 *	选座大图(相对于缩略图)
 */
@SuppressLint({ "DrawAllocation", "ClickableViewAccessibility", "FloatMath" })
	...
	protected void onDraw(Canvas paramCanvas) {
		...
		//		Seat localSeat = this.mListSeatInfos.get(i2).getSeat(i3);
				...
				case 1:// 可选
				  ...
				  this.mCanvas, localPaint2); break;
		...
		// 画排数
		localPaint2.setTextSize(0.4F * this.ss_seat_current_height); // 字体大小
		for (int i1 = 0; i1 < this.mListSeatInfos.size(); i1++) {
			localPaint2.setColor(-1308622848); // 颜色
