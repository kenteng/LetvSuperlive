...
public class ReceiverPrizeView extends BaseView {
	 ...
	 * @param context
	 */
	public ReceiverPrizeView(final Context context) {
		super(context);
	}

	public ReceiverPrizeView(final Context context, Bundle bunlde) {
		...
		try {
			...
			for (int i = 0; i < jsonArr.length(); i++) {
				...
				if (temp.has("couponType")){
					...
					Log.i("wxn", "couponType: "+couponType);
				}
			}
