package com.lesports.stadium.gaode.search;
...
//        pubTypes.clear();
    ...
    private OnItemClickListener mBussinessItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (null != itemMap && itemMap.get(TYPE_KEY_NAME) != null) {
                ...
                List<IMSearchResult> srList = mDataManager.searchByType(type,mDataManager.getCurrentFloorNo());
                ...
                if (featureList.size() == 0) {
                    Toast.makeText(getActivity(), "当前楼层没有类型为" + type + "的商铺", Toast.LENGTH_SHORT).show();
    ...
    private void loadSearchListByKeywords(final String keywords) {
        ...
        int floorIdx=IMDataManager.getInstance().getCurrentFloorNo();
        List<IMSearchResult> srList = IMDataManager.getInstance()
                .searchByName(keywords,0);
        if (null != srList) {
