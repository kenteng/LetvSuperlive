...
public class VideoFragment extends BaseV4Fragment {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case TAG_DATA_DOWN:
				...
				if (!TextUtils.isEmpty(backdata_down)) {
					...
					addDataToList(lists_down, mListview);
				} else {
					Toast.makeText(getActivity(), "网络异常", Toast.LENGTH_SHORT)
							.show();
				}
	...
	public View initView(LayoutInflater inflater) {
		...
		mPulltorefreshlistview = (PullToRefreshListView) mView
				.findViewById(R.id.video_fragment_listview);
...
//				intent.putExtra("heightlightbean", (Serializable)list.get(arg2));
//				intent.putExtra("list", (Serializable) list);
//				startActivity(intent);
				LiveDetialActivity.instance.changeVideo(list.get(arg2));
			}
		});
	}
