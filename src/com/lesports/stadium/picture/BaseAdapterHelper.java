...
public class BaseAdapterHelper {
    ...
    public BaseAdapterHelper setImageResource(int viewId, String imageResId) {
        ImageView view = retrieveView(viewId);
        LApplication.loader.DisplayImage(ConstantValue.BASE_IMAGE_URL
				+ imageResId + ConstantValue.IMAGE_END,view,
				R.drawable.weikaishibeijing_zhanwei);
        return this;
    }
    ...
    @SuppressLint("NewApi") public BaseAdapterHelper setAlpha(int viewId, float value) {
