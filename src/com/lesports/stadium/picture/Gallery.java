...
import com.lesports.stadium.activity.PictureBrowesActivity;
...
public class Gallery extends RelativeLayout {
    ...
    private static int OFFSCREEN_PAGE_LIMIT =0;
...
//    private int galleryPaddingLeft = 10;
//    private int galleryPaddingRight = 10;
//    private int galleryPaddingTop =10;
//    private int galleryPaddingBottom = 10;
//    private int galleryCenterMargin =10;
    ...
    public Gallery(Context context, AttributeSet attrs, int defStyle) {
        ...
        viewPager = (ViewPager) findViewById(R.id.lashi_tupianyulan_view_pager);
...
//        viewPager.setPageMargin(galleryCenterMargin);
    ...
    public class PageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
        	...
        	PictureBrowesActivity.instance.changeDots(arg0);
        	PictureBrowesActivity.instance.mTextNumleft.setText((arg0+1)+"");
        }
