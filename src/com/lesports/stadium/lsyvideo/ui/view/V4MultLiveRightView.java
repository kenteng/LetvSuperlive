...
import com.lesports.stadium.lsyvideo.videoview.live.UIActionLiveSubVideoView;
...
//                    videoView.setVideoLayout(VideoViewSizeHelper.VIDEO_LAYOUT_STRETCH, 0);
    ...
    List<com.lecloud.sdk.api.md.entity.action.LiveInfo> liveInfos;
    public void setStreams(List<com.lecloud.sdk.api.md.entity.action.LiveInfo> liveInfos) {
    ...
    public int indexOfLiveInfo(String liveId) {
        for (com.lecloud.sdk.api.md.entity.action.LiveInfo info : liveInfos) {
