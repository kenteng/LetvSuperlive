package com.lesports.stadium.lsyvideo.ui.impl;
...
import com.lesports.stadium.lsyvideo.ui.ILetvUICon;
...
import com.lesports.stadium.lsyvideo.ui.utils.GestureControl;
import com.lesports.stadium.lsyvideo.ui.utils.GestureControl.GestureControlListener;
import com.lesports.stadium.lsyvideo.ui.utils.ScreenUtils;
import com.lesports.stadium.lsyvideo.ui.view.V4RightMiddleView;
import com.lesports.stadium.lsyvideo.ui.view.V4TopTitleView;
import com.lesports.stadium.lsyvideo.ui.view.VideoLoading;
import com.lesports.stadium.lsyvideo.ui.view.VideoNoticeView;
import com.lesports.stadium.lsyvideo.ui.view.VideoNoticeView.IReplayListener;
import com.lesports.stadium.lsyvideo.ui.view.WaterMarkView;
...
//	public LetvUIListener letvUIListener;
    ...
    protected V4RightMiddleView rightMindleLayout;
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (rightMindleLayout.isLockFlag()) {
                return;
            }
            switch (msg.what) {
...
//	mOrientationSensorUtils.getmOrientationSensorListener().lockOnce(((Activity) context).getRequestedOrientation());
    ...
    public void setRequestedOrientation(int requestedOrientation) {
        ...
        if (requestedOrientation == ILetvVodUICon.SCREEN_LANDSCAPE) {
            ...
            rightMindleLayout.setVisibility(VISIBLE);
            ...
            mSmallMediaController.setSwiperStater();
        }
