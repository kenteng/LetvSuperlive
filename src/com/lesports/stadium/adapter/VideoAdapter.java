...
public class VideoAdapter extends BaseAdapter {
	...
	public VideoAdapter(List<HeightLightBean> list,Context montext){
		mList=list;
		mContext=montext;
	}
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1==null){
			...
			arg1=inflater.inflate(R.layout.item_lv_video,null);
			vh.mtitle=(TextView) arg1.findViewById(R.id.video_hrightlight_lv_item_title);
			vh.mImage=(ImageView) arg1.findViewById(R.id.video_hrightlight_lv_item_image);
			vh.mContent=(TextView) arg1.findViewById(R.id.video_hrightlight_lv_item_time);
			arg1.setTag(vh);
		}else{
		...
		if(mList.get(arg0).getFileSource().equals("1")){
			vh.mContent.setText("乐视云");
		}else{
			vh.mContent.setText("其他来源");
		}
		return arg1;
	}
